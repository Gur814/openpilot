...
class kegman_conf():
    ...
    def read_config(self):
        ...
        if os.path.isfile('/data/kegman.json'):
            ...
            if "ChimeEngage" not in self.config:
                self.config.update({"chimeEngage": True})
                self.element_updated = True

            if "ChimeDisengage" not in self.config:
                self.config.update({"chimeDisengage": True})
                self.element_updated = True
            ...
            self.config = {"cameraOffset": "0.06", "lastTrMode": "1", "battChargeMin": "60", "battChargeMax": "70",
                           ...
                           "ChimeEngage": True, "ChimeDisengage": True}
